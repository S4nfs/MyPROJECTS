...
/*Data Types ---------------------------------------------------------------------------------------------------
Primitive Data Types (These are immutable data and each has an independent value): String, Number, Boolean, Null, Undefined, Symbol
Reference Data Types (Non-primitive types can create a single entity by combining multiple values): Object, Function, Array, Date, RegExp, Error */
// 1. String
// 2. BigInt
// 3. Boolean
// 4. Number
