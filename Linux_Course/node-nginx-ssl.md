...
## 2. Clone this simple Hello World project from Github
...
### You should now be able to visit your IP with no port (port 80) and see your app. Now let's add record to your domain name

## 7. Add record to DNS
```
Add an A record for @ and for www and point it to your IP
```
