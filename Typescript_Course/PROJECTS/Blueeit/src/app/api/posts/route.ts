...
export async function GET(req: Request) {
    ...
    try {
        ...
        }).parse({subredditName: url.searchParams.get('subredditName'),
...
whereClause = {
    subreddit: {
        ...
        if(error instanceof z.ZodError) {return new Response('Invalid data passed', { status: 422 })} //422 invalid data
